...
def test_start_aws_sns_sqs_service_with_credentials_with_custom_protocol(monkeypatch: Any, capsys: Any, loop: Any) -> None:
    services, future = start_service('tests/services/aws_sns_sqs_service_with_credentials_with_custom_protocol.py', monkeypatch)
