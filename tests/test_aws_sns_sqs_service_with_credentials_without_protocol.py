...
def test_start_aws_sns_sqs_service_with_credentials_without_protocol(monkeypatch: Any, capsys: Any, loop: Any) -> None:
    services, future = start_service('tests/services/aws_sns_sqs_service_with_credentials_without_protocol.py', monkeypatch)
