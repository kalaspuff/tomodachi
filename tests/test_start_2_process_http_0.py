...
def test_start_2_process_http_reuse_port_request(capsys: Any, loop: Any) -> None:
    func, future = start_service("tests/services/start_process_service_http_0.py", wait=False, loop=loop)
