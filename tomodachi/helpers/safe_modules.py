...
SAFE_MODULES = {
    ...
    "tomodachi.helpers.aws_credentials",
    ...
    "tomodachi.opentelemetry.auto_instrumentation",
    "tomodachi.opentelemetry.distro",
    "tomodachi.opentelemetry.environment_variables",
    "tomodachi.opentelemetry.exemplars",
    "tomodachi.opentelemetry.instrumentation",
    "tomodachi.opentelemetry.logging",
    "tomodachi.opentelemetry.middleware",
    "tomodachi.opentelemetry.prometheus",
    "tomodachi.watcher",
    "traceback",
    "types",
    "typing",
